...
* [ ] Sistema de archivos ([fs](https://n.org/api/fs.html), [path](https://nodejs.org/api/path.html))
* [ ] [package.json](https://docs.npmjs.com/files/package.json)
* [ ] crear módulos [(CommonJS)](https://n.org/docs/latest-v0.10.x/api/modules.html)
